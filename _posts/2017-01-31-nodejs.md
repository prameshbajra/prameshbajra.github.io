...
title: "Why NODEJS?"
date: 2019-04-05
description: "Covering the what, when, and why of Node.js — and when reaching for it actually pays off."
keywords: "open source, javascript, programming , nodejs, node, serverside, npm, js, code, frontend, backend"
tags: [web]
image: /static/assets/img/og/nodejs.png
icon: icon-nodejs
redirect_from:
  - "/open source/javascript/programming/nodejs/node/serverside/npm/js/code/frontend/backend/2019/04/05/nodejs.html"
---
